...
[![PyPI version](https://badge.fury.io/py/base64-tool.svg)](https://pypi.org/project/base64-tool/)
...
```bash
pip install base64-tool
```

## Quick Start

```python
from base64_tool import tool
